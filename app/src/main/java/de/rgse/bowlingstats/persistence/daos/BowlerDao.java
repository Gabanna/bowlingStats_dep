...
public interface BowlerDao {
    ...
    @Query("SELECT b.name, avg(value) as average, max(value) as max, count(*) as count, dateTime from Bowler b join SeriesEntry e on b.id = e.bowlerId where b.name = :bowlerId group by dateTime")
